...
#this class is used to load the specified 'archive/raw-img'dataset into a pytorch dataset object
...
#this function is used to create the data loaders for the training, validation and test sets
#a data loader is a pytorch object that allows to iterate over the dataset in batches
